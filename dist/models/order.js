...
class OrderDao {
    place(cart) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const orderResult = yield conn.query(orderQuery, [cart.user_id]);
                ...
                const addProductsToOrdersResult = yield Promise.all(promises);
                ...
                const prods = addProductsToOrdersResult.map(r => r.rows[0]);
    ...
    getUserCurrentOrder(user_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            `;
                const result = yield conn.query(query, [user_id]);
                conn.release();
